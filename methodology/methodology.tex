...
The description of the electrons in a system requires the use of QM... outline of standard DFT... situations in which standard DFT fails and why we need to use hybrid-DFT.
