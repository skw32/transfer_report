...
\section{Solar Cell Performance Bottlenecks Due to Crystal Imperfections}\label{defects_in_PV}
...
See pdf from Laurie - method used by PVTEAM to measure band gap broadening of CZTS single crystal
...
Refer to: pg 13 + 21-22 \cite{Bechstedt}\\
