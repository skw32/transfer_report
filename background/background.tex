...
Notes from A. Guinier 'X-Ray Diffraction': use Ch6 to introduce then Ch8 for long and short range order in mixed crystals with substitutional disorder + see Ziman + link to order parameter
