...
In general, the main cause of V$_{OC}$ deficit in a PV device is the recombination of photogenerated charge carriers in the bulk material or at surfaces. The deficit is usually dominated by one particular recombination process. For instance in the case of CIGSe films it is trap-assisted Shockley-Read-Hall recombination \cite{culprit}.

** Review of defect literature (+ CZTS PL?), see culprit paper **
\begin{itemize}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.75\textwidth]{figures/CZTS_PL.png}
